...
export default function BestPartners() {
    return (
        <div className='pt-5 pb-5'>
            <div className='container pt-5 pb-5 flex'>
                <div className="w-[50%] px-[4%] border-r-2 border-[#9c9999]">
                    {/* <Heading Heading2={"We Work With the"} Heading1={""} /> */}
                    <h2 className='md:text-[50px] text-right text-[#989898] leading-[65px]'>We Work With the</h2>
                    <h2 className='md:text-[50px] text-right leading-[65px]'>Best Partners</h2>
                ...
                <div className="w-[50%] px-[4%] flex flex-col justify-center gap-[10%]"
                style={{
